...
/**
 * This is the variable store for the Camera Functions.
 */
public class VstC {
     ...
     */
    public static final double AXIS_CAMERA_V_OBSERVATION_ANGLE = 37.2;
    /**
     * The Angle the camera is mounted at.
     */
    public static final double CAMERA_ANGLE = 0;
    /**
     * The Pixel Width of the camera.
     */
    public static int PIXEL_HEIGHT_OF_CAMERA = 480;
    /**
     * The Pixel Height of the camera.
     */
    public static int PIXEL_WIDTH_OF_CAMERA = 640;
}
